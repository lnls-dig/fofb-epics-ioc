...
static const functionsAny_t fofbCtrlSetGetIntlkEn = {functionsInt32_t{"FOFB_PROCESSING", halcs_set_fofb_processing_intlk_en, halcs_get_fofb_processing_intlk_en}};
                    ...
                    0) /* Default stack size*/
{
    ...
    createParam("INTLK_EN",                          asynParamInt32,                &P_FofbIntlkEn);
    ...
    fofbHwFunc.emplace(P_FofbIntlkEn,                 fofbCtrlSetGetIntlkEn);
    ...
    setIntegerParam(0, P_FofbIntlkEn, 0);
