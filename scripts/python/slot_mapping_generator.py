...
for i in range(1, crates+1, 1):
    ...
    for j in range(1, slots+1, 1):
      if (j == 3 or j == 5):
        if i < 10:
          f1.write("# Crate " + str(i) + " - " + ioc_name + " slot " + str(j) + " - " + pv_area_prefix + "-0" + str(i) + pv_device_prefix + "-" + pv_name_prefix + '\n')
        ...
        if i < 10:
          if j < 10:
            f1.write("# Crate " + str(i) + " - " + ioc_name + " slot " + str(j) + " - " + pv_area_prefix_others + "-0" + str(i) + "SL0" + str(j) + pv_device_prefix + "-" + pv_name_prefix + '\n')
            f1.write("CRATE_" + str(i) + "_" + ioc_name + "_" + str(j) + "_PV_AREA_PREFIX=" + pv_area_prefix_others + "-0" + str(i) + "SL0" + str(j) + '\n')
            f1.write("CRATE_" + str(i) + "_" + ioc_name + "_" + str(j) + "_PV_DEVICE_PREFIX=" + pv_device_prefix + "-" + pv_name_prefix + ":" + '\n'+ '\n')
          else:
            f1.write("# Crate " + str(i) + " - " + ioc_name + " slot " + str(j) + " - " + pv_area_prefix_others + "-0" + str(i) + "SL" + str(j) + pv_device_prefix + "-" + pv_name_prefix + '\n')
