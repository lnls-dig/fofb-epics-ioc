...
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=M1:PS-FCV:, GAIN=CurrGain, OFFSET=CurrOffset, PORT=$(PORT), ADDR=0,  TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=M2:PS-FCH:, GAIN=CurrGain, OFFSET=CurrOffset, PORT=$(PORT), ADDR=0,  TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=M2:PS-FCV:, GAIN=CurrGain, OFFSET=CurrOffset, PORT=$(PORT), ADDR=0,  TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=C2:PS-FCH:, GAIN=CurrGain, OFFSET=CurrOffset, PORT=$(PORT), ADDR=0,  TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=C2:PS-FCV:, GAIN=CurrGain, OFFSET=CurrOffset, PORT=$(PORT), ADDR=0,  TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=C3:PS-FCH:, GAIN=CurrGain, OFFSET=CurrOffset, PORT=$(PORT), ADDR=0,  TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=C3:PS-FCV:, GAIN=CurrGain, OFFSET=CurrOffset, PORT=$(PORT), ADDR=0,  TIMEOUT=1")

dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=XX:PS-FC08:, GAIN=CurrGain, OFFSET=CurrOffset, PORT=$(PORT), ADDR=0,  TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=XX:PS-FC09:, GAIN=CurrGain, OFFSET=CurrOffset, PORT=$(PORT), ADDR=0,  TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=XX:PS-FC10:, GAIN=CurrGain, OFFSET=CurrOffset, PORT=$(PORT), ADDR=0,  TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=XX:PS-FC11:, GAIN=CurrGain, OFFSET=CurrOffset, PORT=$(PORT), ADDR=0,  TIMEOUT=1")

dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=M1:PS-FCH:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=M1:PS-FCV:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=M2:PS-FCH:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=M2:PS-FCV:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=C2:PS-FCH:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=C2:PS-FCV:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=C3:PS-FCH:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=C3:PS-FCV:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")

dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=XX:PS-FC08:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=XX:PS-FC09:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=XX:PS-FC10:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")
dbLoadRecords("${TOP}/FOFBApp/Db/FOFBRtm.template", "P=${P}, R=${R}, S=${S}, RTM_CHAN=XX:PS-FC11:, GAIN=VoltGain, OFFSET=VoltOffset, PORT=$(PORT), ADDR=0, TIMEOUT=1")
