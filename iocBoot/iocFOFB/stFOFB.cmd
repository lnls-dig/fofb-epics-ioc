...
dbLoadRecords("${TOP}/db/FOFBData.template", "P=${P},R=${R},ACQ_NAME=GEN,RTM_CHAN=CH16,FTVL=FLOAT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")
dbLoadRecords("${TOP}/db/FOFBData.template", "P=${P},R=${R},ACQ_NAME=GEN,RTM_CHAN=CH17,FTVL=FLOAT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")
dbLoadRecords("${TOP}/db/FOFBData.template", "P=${P},R=${R},ACQ_NAME=GEN,RTM_CHAN=CH18,FTVL=FLOAT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")
dbLoadRecords("${TOP}/db/FOFBData.template", "P=${P},R=${R},ACQ_NAME=GEN,RTM_CHAN=CH19,FTVL=FLOAT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")
dbLoadRecords("${TOP}/db/FOFBData.template", "P=${P},R=${R},ACQ_NAME=GEN,RTM_CHAN=CH20,FTVL=FLOAT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")
dbLoadRecords("${TOP}/db/FOFBData.template", "P=${P},R=${R},ACQ_NAME=GEN,RTM_CHAN=CH21,FTVL=FLOAT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")
dbLoadRecords("${TOP}/db/FOFBData.template", "P=${P},R=${R},ACQ_NAME=GEN,RTM_CHAN=CH22,FTVL=FLOAT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")
dbLoadRecords("${TOP}/db/FOFBData.template", "P=${P},R=${R},ACQ_NAME=GEN,RTM_CHAN=CH23,FTVL=FLOAT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")
dbLoadRecords("${TOP}/db/FOFBData.template", "P=${P},R=${R},ACQ_NAME=GEN,RTM_CHAN=CH24,FTVL=FLOAT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")
