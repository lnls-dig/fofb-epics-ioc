...
export FOFB_CURRENT_PV_AREA_PREFIX=${EPICS_PV_CRATE_PREFIX}_FOFB_${FOFB_NUMBER}_PV_AREA_PREFIX
export FOFB_CURRENT_PV_DEVICE_PREFIX=${EPICS_PV_CRATE_PREFIX}_FOFB_${FOFB_NUMBER}_PV_DEVICE_PREFIX
